...
**⚠️ CRITICAL**: All development MUST use the centralized configuration system. **No exceptions**.

- **📋 Table Configuration**: [`shared/table_config.py`](shared/table_config.py) - Master table registry
- **🔧 Database Configuration**: [`shared/database_config.py`](shared/database_config.py) - Centralized DB config  
- **📖 Full Instructions**: [`CENTRALIZED_CONFIG_INSTRUCTIONS.md`](CENTRALIZED_CONFIG_INSTRUCTIONS.md) - Complete guidelines
...
table_name = CRYPTO_TABLES["ONCHAIN_DATA"]  # "crypto_onchain_data"
connection = get_db_connection()

# ❌ WRONG - Hard-coded values
table_name = "crypto_onchain_data"          # DON'T DO THIS
config = {'host': '172.22.32.1'}           # DON'T DO THIS
```

**📚 Required Reading**: Review [`CENTRALIZED_CONFIG_INSTRUCTIONS.md`](CENTRALIZED_CONFIG_INSTRUCTIONS.md) before any development.
...
- **[� Centralized Config Instructions](CENTRALIZED_CONFIG_INSTRUCTIONS.md)** - **REQUIRED READING** - All development guidelines
- **[📋 Table Configuration](shared/table_config.py)** - Master table registry and validation
- **[🔧 Database Configuration](shared/database_config.py)** - Centralized database configuration
- **[📖 Configuration Summary](CENTRALIZED_CONFIG_SUMMARY.md)** - Summary of configuration achievements
...
- **[GitHub Copilot Instructions](.copilot-instructions.md)** - Centralized configuration guidelines for AI-assisted development
- **[Development Guide](docs/DEVELOPMENT_GUIDE.md)** - Complete development standards and patterns
- **[Monitoring & Observability](docs/MONITORING_OBSERVABILITY.md)** - Grafana dashboards, alerting, and operational procedures
- **[Production Operations](docs/PRODUCTION_OPERATIONS.md)** - Day-to-day operational procedures
