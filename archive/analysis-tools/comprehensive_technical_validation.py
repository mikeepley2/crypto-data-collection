...
def validate_technical_indicators():
    ...
    try:
        ...
        for indicator, count in indicators.items():
            ...
            print(
                f"{status} {indicator:15} {count:>12,} / {total:>12,}  ({pct:>6.2f}%)"
            )
        ...
        print(
            f"Records with ALL 5 indicators: {complete[1]:,} / {complete[0]:,} ({complete_pct:.2f}%)"
        )
        print()
        ...
        print(
            f"SMA 20:        MIN={stats[0]:>12.4f}, MAX={stats[1]:>12.4f}, AVG={stats[2]:>12.4f}"
        )
        print(
            f"RSI 14:        MIN={stats[3]:>12.4f}, MAX={stats[4]:>12.4f}, AVG={stats[5]:>12.4f}  (valid: 0-100)"
        )
        print(
            f"MACD:          MIN={stats[6]:>12.4f}, MAX={stats[7]:>12.4f}, AVG={stats[8]:>12.4f}"
        )
        if stats[9] is not None:
            print(
                f"Bollinger W:   MIN={stats[9]:>12.4f}, MAX={stats[10]:>12.4f}, AVG={stats[11]:>12.4f}"
            )
        print()
        ...
        print(
            f"{'Symbol':<8} | {'Total':>8} | {'SMA20%':>7} | {'RSI%':>7} | {'MACD%':>7} | {'BB%':>7}"
        )
        print("-" * 65)
        ...
        for sym in symbols:
            ...
            print(
                f"{sym[0]:<8} | {sym[1]:>8,} | {sma_pct:>6.1f}% | {rsi_pct:>6.1f}% | {macd_pct:>6.1f}% | {bb_pct:>6.1f}%"
            )
        ...
        if all_pass:
            ...
            print(
                f"  - Bollinger coverage:    {(indicators['Bollinger']/total*100):.2f}%"
            )
