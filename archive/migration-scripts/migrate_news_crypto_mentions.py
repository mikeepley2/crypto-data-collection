...
This script migrates crypto_mentions fields in news tables from old format symbols
(BTC, ETH, ADA, SOL, BITCOIN, etc.) to canonical coingecko_id format 
(bitcoin, ethereum, cardano, solana, etc.) using the shared symbol normalizer.
"""
