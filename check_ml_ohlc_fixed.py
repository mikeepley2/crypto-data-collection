...
def main():
    ...
    SELECT 
        ...
        SUM(CASE WHEN ohlc_volume IS NOT NULL THEN 1 ELSE 0 END) as volume_populated,
        ...
        ROUND(SUM(CASE WHEN ohlc_volume IS NOT NULL THEN 1 ELSE 0 END) * 100.0 / COUNT(*), 2) as volume_percentage
    ...
    # Check if continuous updater is working
    cursor.execute("""
    ...
    print(f'Last ML update: {update_result[0]} ({update_result[1]} minutes ago)')
